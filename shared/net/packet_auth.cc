...
void AuthChallenge_Packet::encode(const AuthChallenge_Packet& packet, WriteBuffer& buffer)
{
    buffer.write_bytes(packet.nonce);
}

void AuthChallenge_Packet::decode(AuthChallenge_Packet& packet, ReadBuffer& buffer)
{
    buffer.read_bytes(packet.nonce);
}

void AuthResponse_Packet::encode(const AuthResponse_Packet& packet, WriteBuffer& buffer)
{
    buffer.write_bytes(packet.signature);
}

void AuthResponse_Packet::decode(AuthResponse_Packet& packet, ReadBuffer& buffer)
{
    buffer.read_bytes(packet.signature);
}

void AuthAdmission_Packet::encode(const AuthAdmission_Packet& packet, WriteBuffer& buffer)
{
...
void AuthAdmission_Packet::decode(AuthAdmission_Packet& packet, ReadBuffer& buffer)
{
