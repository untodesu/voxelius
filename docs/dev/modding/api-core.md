...
As mentioned in the [overview](init-overview.md), namespaced identifiers can have the namespace omitted and be replaced with a default value. That value for mods is also contained in the `core.NAMESPACE` constant.  
