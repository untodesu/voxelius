...
template<vx::char_type T>
std::basic_string_view<T> remove_comments(std::basic_string_view<T> string) noexcept;
template<vx::char_type T>
std::vector<std::basic_string_view<T>> tokenize(std::basic_string_view<T> string) noexcept;
} // namespace utils
